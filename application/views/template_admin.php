      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="<?= base_url(); ?>" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">welcome CMS</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item <?php if ($menu == 'dashboard') {
                                  echo "active";
                                } ?>">
          ...
          <?php if ($this->session->userdata('level') == 'Admin') { ?>
            <li class="menu-item <?php if ($menu == 'pengguna') {
                                    echo "active";
                                  } ?>">
          ...
          <li class="menu-item <?php if ($menu == 'konten') {
            ...
            <a href="<?= base_url('admin/konten') ?>" class="menu-link">
          ...
          <li class="menu-item <?php if ($menu == 'caraousel') {
            ...
            <a href="<?= base_url('admin/caraousel') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-cog"></i>
              <div data-i18n="caraousel">caraousel</div>
            </a>
          </li>
          </li>
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="<?= base_url('assets/upload/profile/') ?>1.png" alt class="w-px-40 h-auto rounded-circle" />
                  </div>
                </a>
          ...
          <footer class="content-footer footer bg-footer-theme">
            <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
              <div class="mb-2 mb-md-0">
                ...
                , create by
                <a href="https://telegram" target="_blank" class="footer-link fw-bolder">SAIAA</a>
              </div>
              <div>
              </div>
            </div>
