...
<body>
    ...
    <!-- <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-primary mb-3"><span class="fw-light text-dark"></span></h1>
            </div>
            <div class="row g-4">
                    ...
                    foreach ($contens as $konten) { ?>
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                            <div class="blog-item border h-100 p-4">
                                ...
                                <p class="mb-4"><?= $konten['keterangan'] ?></p>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="<?= base_url('assets/upload/konten/') . $artikel->foto; ?>">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="text-primary mb-4"><?= $artikel->judul; ?></h1>
                    <p><?= $artikel->keterangan; ?></p>
                    <a class="btn btn-primary py-2 px-4" href="">Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid newsletter bg-primary py-5 my-5">
        <div class="container py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-white mb-3"><span class="fw-light text-dark">Support Websiteku</span> Saya akan semangat</h1>
                <p class="text-white mb-4">Support terus websit || Rahmadi</p>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>Alamat <?= $konfig->alamat; ?></p>
                    <p><i class="fa fa-phone-alt me-3"></i>No WhatsAap <?= $konfig->no_wa; ?></p>
                    <p><i class="fa fa-envelope me-3"></i>Email <?= $konfig->email; ?></p>
